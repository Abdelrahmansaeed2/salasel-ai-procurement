...
EXTRACT_SYSTEM_PROMPT = (
    ...
    "- product_name: the item being purchased (required, MUST BE TRANSLATED TO ENGLISH)\n"
    "- quantity: how many units they asked for, or null if not stated\n"
    "- category: if clear from context, else null (MUST BE IN ENGLISH)\n"
    "- requested_attributes: key/value pairs the customer specified (size, color, packaging, units, etc., translated to ENGLISH)\n"
    ...
    "- If the transcript is in Arabic, translate ALL extracted product names and attributes to English to match the catalog.\n"
