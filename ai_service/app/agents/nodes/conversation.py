...
- product_name: the item the customer is looking for, translated to ENGLISH (e.g. "nitrile gloves", "Premium Egyptian Rice")
- price_min / price_max: only when the customer states a budget
- required_attributes (key-value pairs the customer mentions, specific to the product, translated to ENGLISH)
...
- If the customer's message is in Arabic or another language, translate ALL extracted fields to English to match the catalog.
