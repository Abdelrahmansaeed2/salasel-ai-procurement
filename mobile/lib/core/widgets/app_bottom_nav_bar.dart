...
List<_NavItemData> _getNavItems(bool isSetupMode, BadgeController badgeCtrl) => [
  _NavItemData(
    label: isSetupMode ? 'المتجر' : 'الرئيسية',
    svgPath: isSetupMode
        ? 'M3 21V9L12 2L21 9V21H3Z M9 21V12H15V21 M3 9L12 2L21 9 M8 9H16V12H8V9Z'
  ...
  _NavItemData(
    label: 'التسوق',
    svgPath:
        'M2.25 3H4.801C5.467 3 6.046 3.456 6.223 4.103L8.031 10.741C8.208 11.388 8.787 11.844 9.453 11.844H16.486C17.152 11.844 17.731 11.388 17.908 10.741L19.463 5.03C19.689 4.199 19.066 3.375 18.204 3.375H6.223M7.5 16.5C7.5 17.328 6.828 18 6 18C5.172 18 4.5 17.328 4.5 16.5C4.5 15.672 5.172 15 6 15C6.828 15 7.5 15.672 7.5 16.5ZM18 16.5C18 17.328 17.328 18 16.5 18C15.672 18 15 17.328 15 16.5C15 15.672 15.672 15 16.5 15C17.328 15 18 15.672 18 16.5Z',
  ),
  _NavItemData(
    label: 'المخزون',
    badgeCount: badgeCtrl.inventoryBadge.value > 0 ? badgeCtrl.inventoryBadge.value : null,
    svgPath:
  ...
  _NavItemData(
    label: 'الطلبات',
    badgeCount: badgeCtrl.ordersBadge.value > 0 ? badgeCtrl.ordersBadge.value : null,
    svgPath:
    ...
    return Directionality(
      ...
      child: DecoratedBox(
        ...
        child: SafeArea(
          top: false,
          child: Obx(() {
            final navItems = _getNavItems(isSetupMode, badgeCtrl);
            return Row(
