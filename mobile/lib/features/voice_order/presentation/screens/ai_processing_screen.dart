...
final List<_StepIcon> _stepIcons = [
  _StepIcon(
    width: 17.w,
    height: 17.h,
    path:
...
class _AnimatedMascotImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CachedNetworkImage(
      ...
      errorWidget: (_, __, ___) => SizedBox(width: 141.w, height: 166.56.h),
    );
  }
}
...
class _StepTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor = state == ProcessingStepState.pending
        ? Color(0xFF27272A)
        : Color(0xFF2563EB);
    final titleColor = isCompletedOrActive ? Color(0xFF2563EB) : Color(0xFF333333);
