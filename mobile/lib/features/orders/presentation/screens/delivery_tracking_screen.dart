    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16.h),
          _buildSupplierCard(
            storeName: controller.supplierName.value.isNotEmpty ? controller.supplierName.value : 'المورد',
            isActive: controller.supplierStatus.value != 'تم التوصيل',
            statusLabel: controller.supplierStatus.value.isNotEmpty ? controller.supplierStatus.value : 'جاري التوصيل',
            driverName: controller.driverName.value,
            timeRemaining: controller.estimatedDeliveryTime.value,
            hasTrackAction: controller.supplierStatus.value != 'تم التوصيل',
          ),
        ],
      ),
    );
