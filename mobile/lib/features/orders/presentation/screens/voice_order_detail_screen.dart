        ...
        child: Container(
          ...
          child: SafeArea(
            ...
            child: Obx(() {
              ...
              final isDraft = status == 'AI_Draft';

              if (isDraft) {
                // Show Confirm + Cancel buttons for draft orders
                return Row(
                  children: [
                    Expanded(
                      child: SizedBox(
                        ...
                        child: OutlinedButton(
                          ...
                          child: controller.isCancelling.value
                              ? const SizedBox(
                                  width: 20,
                                  height: 20,
                                  child: CircularProgressIndicator(strokeWidth: 2, color: Color(0xFFBA1A1A)),
                                )
                              : Text(
                                  'إلغاء الطلب',
                                  style: TextStyle(
                    ...
                    Expanded(
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: controller.isConfirming.value ? null : controller.confirmOrder,
              ...
              // For all other statuses: show Download Receipt + Reorder
              return Row(
                children: [
                  Expanded(
                    child: SizedBox(
