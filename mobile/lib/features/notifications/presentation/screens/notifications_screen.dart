                              ...
                              ...c.filteredNotifications.map((notif) {
                                ...
                                return Padding(
                                  ...
                                  child: _NotificationCard(
                                    iconBg: notif.isRead ? const Color(0xFFE2E8F0) : const Color(0x33BC4800),
                                    iconColor: notif.isRead ? Colors.grey : const Color(0xFFBC4800),
                                    iconPath:
                                    ...
                                    iconWidth: 16,
                                    iconHeight: 20,
                                    title: notif.payload['title']?.toString() ?? notif.eventName,
                                    description: notif.payload['message']?.toString() ?? '',
                                    buttonLabel: 'التفاصيل',
                                    radius: 8,
                                    onButtonTap: () {
                                      if (!notif.isRead) {
                                        c.markAsRead(notif.id);
                                      }
                                    },
                                  ),
                                );
